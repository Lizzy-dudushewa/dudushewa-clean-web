      ...
      <div className="max-width py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <FooterLink href="#services">Residential Cleaning</FooterLink>
              <FooterLink href="#services">Commercial Cleaning</FooterLink>
              <FooterLink href="#services">Specialized Cleaning</FooterLink>
              <FooterLink href="#services">Deep Cleaning</FooterLink>
              <FooterLink href="#services">Move In/Out Cleaning</FooterLink>
            </ul>
          </div>
        ...
        <div className="flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="flex space-x-6 mt-4 md:mt-0">
            <FooterLink href="#" size="sm">Privacy Policy</FooterLink>
            <FooterLink href="#" size="sm">Terms of Service</FooterLink>
            <FooterLink href="#" size="sm">Sitemap</FooterLink>
          </div>
        </div>
      </div>
    </footer>
